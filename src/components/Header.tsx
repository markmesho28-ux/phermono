            ...
            <div className="flex items-center justify-between h-20 gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  aria-label="Wishlist"
                >
                  <Heart size={21} className="group-hover:text-red-500 transition-colors pointer-events-none" />
                  {wishlistCount > 0 && (
                    <span className="absolute top-0.5 right-0.5 min-w-[19px] h-[19px] bg-red-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center px-1 shadow-sm animate-fadeIn pointer-events-none">
                      {wishlistCount}
                    </span>
                  )}
                </button>
                ...
                >
                  ...
                  <span className="text-xs font-semibold tracking-wider uppercase hidden sm:inline pointer-events-none">
                    Bag
                  </span>
                </button>
                ...
                <button
                  ...
                  className="ml-2 p-2.5 rounded-full hover:bg-brand-gold-light/60 text-brand-black transition-colors"
                  aria-label="Track Orders"
                >
                  <Truck size={18} className="pointer-events-none" />
                </button>
              </div>
            </div>
